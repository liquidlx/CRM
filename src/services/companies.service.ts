import { HttpCode, HttpException, Injectable, InternalServerErrorException } from "@nestjs/common";
...
export class CompaniesService {
     ...
     * @returns Company
     */
    async delete(where: Prisma.CompaniesWhereUniqueInput,): Promise<Companies | null> {
     ...
     * @returns Company
     */
    async findOne(where: Prisma.CompaniesWhereUniqueInput): Promise<Companies | null> {
